...
namespace Zero {
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		if (ImGui::BeginPopup(u8"添加组件"))
		{
			...
			DisplayAddComponentEntry<SpriteRendererComponent>(u8"Sprite渲染器");
			DisplayAddComponentEntry<CircleRendererComponent>(u8"圆形渲染器");
			DisplayAddComponentEntry<Rigidbody2DComponent>(u8"2D刚体");
			DisplayAddComponentEntry<BoxCollider2DComponent>(u8"2D箱体碰撞体");
			DisplayAddComponentEntry<CircleCollider2DComponent>(u8"2D圆形碰撞体");
			DisplayAddComponentEntry<TextComponent>(u8"文本渲染器");
		...
		{
			DrawVec3Control(u8"平移", component.Translation);
		...
		DrawComponent<CameraComponent>(u8"摄像机", entity, [](auto& component)
		{
			...
			ImGui::Checkbox(u8"主摄像机", &component.Primary);
		...
		DrawComponent<SpriteRendererComponent>(u8"Sprite渲染器", entity, [](auto& component)
		{
		...
		DrawComponent<CircleRendererComponent>(u8"圆形渲染器", entity, [](auto& component)
		{
			ImGui::ColorEdit4(u8"颜色", glm::value_ptr(component.Color));
			ImGui::DragFloat(u8"厚度", &component.Thickness, 0.025f, 0.0f, 1.0f);
			ImGui::DragFloat(u8"模糊", &component.Fade, 0.00025f, 0.0f, 1.0f);
		});

		DrawComponent<Rigidbody2DComponent>(u8"2D刚体", entity, [](auto& component)
		{
			const char* bodyTypeStrings[] = { u8"静态", u8"动态", u8"Kinematic"};
		...
		DrawComponent<BoxCollider2DComponent>(u8"2D箱体碰撞体", entity, [](auto& component)
		{
			...
			ImGui::DragFloat(u8"恢复力", &component.Restitution, 0.01f, 0.0f, 1.0f);
			ImGui::DragFloat(u8"恢复阈值", &component.RestitutionThreshold, 0.01f, 0.0f);
		});

		DrawComponent<CircleCollider2DComponent>(u8"2D圆形碰撞体", entity, [](auto& component)
		{
			ImGui::DragFloat2(u8"偏移", glm::value_ptr(component.Offset));
		...
		DrawComponent<TextComponent>(u8"文本渲染器", entity, [](auto& component)
		{
			ImGui::InputTextMultiline(u8"文本串", &component.TextString);
			ImGui::ColorEdit4(u8"颜色", glm::value_ptr(component.Color));
			ImGui::DragFloat(u8"字间距", &component.Kerning, 0.025f);
			ImGui::DragFloat(u8"行间距", &component.LineSpacing, 0.025f);
		});
